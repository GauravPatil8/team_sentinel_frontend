  ...
  return (
    <div className="mt-8 p-6 bg-white rounded-xl shadow-md">
      ...
      <div className="relative">
        {/* Connecting line */}
        <div className="absolute top-16 left-[50%] w-[1px] h-[calc(100%-80px)] bg-primary/30"></div>
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="bg-primary/5 p-4 rounded-lg flex-1">
              <h5 className="font-medium">Pickup or Delivery</h5>
              <p className="text-sm text-muted-foreground">Collect your printed documents or get them delivered</p>
            </div>
          </motion.div>
        </div>
      </div>
